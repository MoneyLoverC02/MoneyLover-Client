...
//     const [checkRegisterStatus, setCheckRegisterStatus] = useState(false);
...
//                     if (newUser && res.data.message === 'Login success!') {
//                         dispatch(registerSuccess())
//                         setCheckRegisterStatus(true)
//
//                     } else {
...
//             }
//             if (successMessageRegister && !successMessageRegister.contains(event.target)) {
//                 setCheckRegisterStatus(true);
//             }
//         };
...
//                                     </div>
//                                     <button className="bg-normalgreen uppercase w-full font-semibold text-white rounded-lg py-[6px]">{isLogin ? "Log In" : "Register"}</button>
//                                 </form>
...
//                     {(checkRegisterStatus && !isLogin) ? <div id="successMessageRegister" className="mx-auto text-center bg-black text-amber-50 mt-12 rounded shadow-md px-8 py-3 w-max">Email .</div> : null}
//                 </div>
//             </div>
//         </>
//     )
