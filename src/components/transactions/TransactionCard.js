...
export default function TransactionCard({openModal, closeModal}) {
    ...
    useEffect(() => {
        let totalInflow = 0;
        let totalOutflow = 0
        allTransaction ? allTransaction.forEach(item => {
                    ...
                    {allTransaction?.length > 0 ? (<>
                        <div
                            ...
                            <div className="pt-4 bg-white">
                                <div
                                    className="h-[48px] w-[600px] fomt-normal border-b flex justify-center fixed scroll-stopper"
                                ...
                                <div className="bg-zinc-100 mt-[48px] text-center">
                                    <div>
                                        <div id='all-trans'
                                             className='bg-white text-zinc-600 text-sm font-medium text-center mb-8'>
                                            <div>
                                                ...
                                                <div
                                                    className='px-4 py-3 uppercase text-center text-lightgreen hover:cursor-pointer'>
